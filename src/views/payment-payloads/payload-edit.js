            ...
            activePayment?.label === 'wallet' ? (
              ...
              <>
                ...
                {activePayment?.label === 'paystack' ? (
                  ...
                  <Col span={12}>
                    <Form.Item label={t("flw_sk")} name="flw_sk" rules={[{required: true, message: t("required")}]}>
                      <Input/>
                    </Form.Item>
                  </Col>
                  <Col span={12}>
                    <Form.Item label={t("title")} name="title" rules={[{required: true, message: t("required")}]}>
                      <Input/>
                    </Form.Item>
                  </Col>
                  <Col span={12}>
                    <Form.Item label={t("description")} name="description" rules={[{required: true, message: t("required")}]}>
                      <Input/>
                    </Form.Item>
                  </Col>
                  <Col span={12}>
