...
import { fetchComboCategories } from 'redux/slices/combo-categories';
...
const CategoryList = () => {
  ...
  const goToEdit = (row) => {
    dispatch(
      addMenu({
        url: `combo-categories/${row.uuid}`,
        id: 'combo_category_edit',
        name: t('edit.combo.category'),
      }),
    );
    navigate(`/combo-categories/${row.uuid}`);
  };

  const goToAdd = () => {
    dispatch(
      addMenu({
        id: 'combo_categories_add',
        url: 'combo-categories/add',
        name: t('add.combo.category'),
      }),
    );
    navigate('/combo-categories/add');
  };
  ...
  const goToClone = (uuid) => {
    dispatch(
      addMenu({
        id: `combo_categories_clone`,
        url: `combo-categories-clone/${uuid}`,
        name: t('combo.category.clone'),
      }),
    );
    navigate(`/combo-categories-clone/${uuid}`);
  };
  ...
  const fetch = () => {
    dispatch(fetchComboCategories(params));
