...
export default function ShopCategoryForm({ form, handleSubmit }) {
  ...
  const fetchCategories = (search) => {
    const params = { perPage: 100, type: 'shop', search: search || undefined };
          ...
          <CustomCard title={t('additional.information')}>
            <Row gutter={12}>
              <Col span={8}>
                ...
                >
                  <RefetchSearch allowClear fetchOptions={fetchCategories} />
                </Form.Item>
              </Col>
              <Col span={8}>
                <Form.Item
